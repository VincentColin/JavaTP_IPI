...
//        return  productsFilters;
    ...
    public Product afficherUnProduit(@PathVariable int id) {
        ...
        if(prod==null) throw new ProductNotFoundException("Le produit avec l'id "+id+" n'existe pas");
        return prod;
    }
    ...
    public ResponseEntity<Void> ajouterProduit(@Valid @RequestBody Product product) {
        if(product.getPrix() == 0) throw new ProduitGratuitException("Tu peux pas faire ça gratuit");
